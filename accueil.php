...
<head>
    ...
    <title>Jocelyn Vourron - Accueil</title>
...
<body class="fixed-sn light-blue-skin">
    ...
    <header>
        ...
        <div id="slide-out" class="side-nav sn-bg-4 fixed mdb-sidenav">
            <ul class="custom-scrollbar list-unstyled wow fadeInLeft" style="max-height:100vh;" data-wow-delay="0.3s">
                <!-- Logo -->
                <li>
                    <div class="logo-wrapper waves-light">
                        <a href="#"><img src="rss/mascotte_pseudo.png" class="img-fluid flex-center"></a>
                    </div>
                </li>
                <!--/. Logo -->
                <!--Social-->
                <li>
                    <ul class="social">
                        ...
                        <li><a href="#" class="icons-sm pin-ic"><i class="fa fa-github"> </i></a></li>
                ...
                <li>
                    <ul class="collapsible collapsible-accordion">
                        <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-book"></i>Cours<i class="fa fa-angle-down rotate-icon"></i></a>
                            <div class="collapsible-body">
                                <ul>
                                    <li><a href="#" class="waves-effect">Accéder aux cours</a>
                                    </li>
                                    <li><a href="#" class="waves-effect">Mettre en ligne un cours</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-briefcase"></i> Devoirs<i class="fa fa-angle-down rotate-icon"></i></a>
                            <div class="collapsible-body">
                                <ul>
                                    <li><a href="#" class="waves-effect">Accéder aux devoirs</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-eye"></i> En savoir plus sur le site<i class="fa fa-angle-down rotate-icon"></i></a>
                            <div class="collapsible-body">
                                <ul>
                                    <li><a href="#" class="waves-effect">Comment utiliser le site ?</a>
                                    </li>
                                    <li><a href="#" class="waves-effect">Le fonctionnement du site</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-lock"></i> Espace Administrateur<i class="fa fa-angle-down rotate-icon"></i></a>
                            <div class="collapsible-body">
                                <ul>
                                    <li><a href="#" class="waves-effect">Panel d'administration</a>
                                    </li>
                                    <li><a href="#" class="waves-effect">Création d'utilisateur</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
        ...
        <nav class="navbar fixed-top navbar-toggleable-md navbar-expand-lg scrolling-navbar double-nav">
            ...
            <ul class="nav navbar-nav nav-flex-icons ml-auto">
                <li class="nav-item">
                    <a class="nav-link"><i class="fa fa-comments-o"></i> <span class="clearfix d-none d-sm-inline-block">Faire un retour</span></a>
                </li>
                &nbsp;
                <li class="nav-item avatar dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-secondary">
                        ...
                        <a class="dropdown-item waves-effect waves-light" href="#">Modifier mon mot de passe</a>
